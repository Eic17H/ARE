I. GETTING STARTED WITH THE 8088 ASSEMBLER AND TRACER TOOLKIT FOR OS X

By now you should have unzipped the distribution file and changed to the
mac directory. You should see the following directories:
...
* bin	      The Mac executable programs as88, s88, and t88
...
this software. On Linux and Unix platforms, including the Mac, the
command "make" should recompile the sources and place the binaries in
the directories "bin",  "examples", and "exercise."

To recompile, you need a working gcc compiler installed. If you have one,
you can compile by typing from the mac directory:
