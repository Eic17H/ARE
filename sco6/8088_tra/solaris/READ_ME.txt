I. GETTING STARTED WITH THE 8088 ASSEMBLER AND TRACER TOOLKIT FOR SOLARIS

By now you should have unzipped the distribution file and changed to the
solaris directory. You should see the following directories:
...
* bin	      The Solaris executable programs as88, s88, and t88
...
this software. On Unix and Solaris platforms, the command "make" should
...
you can compile by typing from the solaris directory:
